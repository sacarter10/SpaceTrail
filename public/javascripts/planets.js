...
var Planet = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			'span',
			{ className: 'planet', style: planetStyle },
			this.props.name
		);
	}
});
...
var Planets = React.createClass({
	...
	getInitialState: function () {
		...
		if (isNode) {
			...
			return {
				planets: [{ name: "Sun", top: 0, left: 0 }, { name: "mercury", top: 0, left: 0 }, { name: "venus", top: 0, left: 0 }, { name: "earth", top: 0, left: 0 }, { name: "mars", top: 0, left: 0 }, { name: "jupiter", top: 0, left: 0 }, { name: "saturn", top: 0, left: 0 }, { name: "uranus", top: 0, left: 0 }, { name: "neptune", top: 0, left: 0 }, { name: "pluto", top: 0, left: 0 }],
				date: ''
			};
		}
	},
...
if (isNode) {
	...
	ReactDOM.render(React.createElement(Planets, null), document.getElementById("star-date"));
}
